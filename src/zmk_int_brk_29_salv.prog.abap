*&---------------------------------------------------------------------*
*& Report Z09_MK_PROG29
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zmk_int_brk_29_salv.
...
START-OF-SELECTION.
  ...
  lo_display->set_list_header( value = 'SALV Education Video' ).
  ...
  TRY.
      ...
      lo_col->set_long_text( value = 'New Invoice Regulator' ).
      lo_col->set_medium_text( value = 'New Invoice' ).
      lo_col->set_short_text( value = 'Invoice' ).
  ...
  lo_h_label->set_text( value = 'Title First Line' ).
